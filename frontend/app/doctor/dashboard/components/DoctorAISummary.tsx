...
export default function DoctorAISummary({ patientId, patientName }: { patientId?: number; patientName?: string }) {
    ...
    useEffect(() => {
        ...
        }).then(r => r.json()).then(d => { if (mounted) { setAi(d); setLoadingAi(false); } }).catch(() => { if (mounted) setLoadingAi(false); });
    ...
    if (loadingRecords || loadingAi) return (
        <div style={{ padding: 60, textAlign: "center", color: "var(--text-secondary)" }}>
            ...
            <div>{loadingRecords ? "Fetching patient records…" : "Gemini AI is analyzing medical history…"}</div>
        </div>
    );
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ padding: "10px 14px", background: "rgba(59,130,246,0.08)", border: "1px solid rgba(59,130,246,0.15)", borderRadius: 8, fontSize: "0.82rem", color: "#93c5fd" }}>
                🤖 Generated by Gemini AI based on {records.length} patient records. Use clinical judgment alongside this summary.
            </div>

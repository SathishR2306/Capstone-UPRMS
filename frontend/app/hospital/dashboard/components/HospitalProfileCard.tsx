    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 24 }}>
                <div style={{ background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-card)", boxShadow: "var(--shadow-card)", padding: "24px", display: "flex", alignItems: "center", gap: 20 }}>
                    ...
                    <div>
                        <div style={{ fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>Patients Linked</div>
                        <div style={{ fontSize: "2rem", fontWeight: 800, color: "var(--text-dark)", lineHeight: 1 }}>{stats.totalPatients}</div>
                    </div>
                </div>
                ...
                <div style={{ background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-card)", boxShadow: "var(--shadow-card)", padding: "24px", display: "flex", alignItems: "center", gap: 20 }}>
                    ...
                    <div>
                        <div style={{ fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>Records Uploaded</div>
                        <div style={{ fontSize: "2rem", fontWeight: 800, color: "var(--text-dark)", lineHeight: 1 }}>{stats.totalRecords}</div>
                    </div>
                </div>
            </div>

            {/* Profile Info */}
            <div style={{ background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-card)", boxShadow: "var(--shadow-card)", padding: "32px" }}>
                <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--text-dark)", marginBottom: 24, paddingBottom: 16, borderBottom: "1px solid var(--border-light)" }}>Hospital Identity</h3>
                <div style={{ display: "flex", gap: 32, alignItems: "flex-start", flexWrap: "wrap" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 260 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                            <h2 style={{ fontWeight: 800, fontSize: "1.6rem", color: "var(--text-dark)", margin: 0 }}>{profile.hospitalName}</h2>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--text-medium)", fontSize: "0.95rem" }}>
                                <LuCalendar size={18} />
                                <span style={{ fontWeight: 500, width: 140 }}>Registration No:</span>
                                <span style={{ fontWeight: 600, color: "var(--text-dark)" }}>{profile.registrationNumber}</span>
                            </div>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--text-medium)", fontSize: "0.95rem" }}>
                                ...
                                {editMode ? (
                                    <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                                        <input value={phone} onChange={e => setPhone(e.target.value)} style={{ padding: "6px 12px", width: 160, border: "1px solid var(--border-light)", background: "var(--input-bg)", borderRadius: 6, color: "var(--text-dark)" }} />
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                                        <span style={{ fontWeight: 600, color: "var(--text-dark)" }}>{profile.phone}</span>
            ...
            {stats.recentActivity && stats.recentActivity.length > 0 && (
                <div style={{ background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-card)", boxShadow: "var(--shadow-card)", padding: "32px" }}>
                    <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--text-dark)", marginBottom: 20 }}>Recent Upload Activity</h3>
                    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        {stats.recentActivity.map((act) => (
                            <div key={act.id} style={{ display: "flex", gap: 16, alignItems: "center", padding: "16px", background: "rgba(255,255,255,0.02)", border: "1px solid var(--border-card)", borderRadius: 12 }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    <div style={{ fontSize: "0.95rem", fontWeight: 600, color: "var(--text-dark)", marginBottom: 4 }}>Uploaded Medical Record for {act.patientName}</div>
                                    <div style={{ fontSize: "0.85rem", color: "var(--text-medium)" }}>Diagnosis: {act.diagnosis}</div>
                                </div>

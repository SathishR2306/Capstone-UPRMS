...
import CreatePatientTab from "./components/CreatePatientTab";
import CreateDoctorTab from "./components/CreateDoctorTab";

type Tab = "overview" | "search" | "upload" | "timeline" | "ai" | "audit" | "doctors" | "create_patient" | "create_doctor";
...
const TABS: { id: Tab; label: string; icon: React.ReactElement; color: string }[] = [
    ...
    {
        id: "create_patient", label: "Create Patient", color: "#06b6d4",
        icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><line x1="19" y1="8" x2="19" y2="14" /><line x1="22" y1="11" x2="16" y2="11" /></svg>,
    },
    {
...
const TAB_META: Record<Tab, { title: string; subtitle: string }> = {
    ...
    create_patient: { title: "Create Patient Account", subtitle: "Register a new patient and generate their login credentials" },
            ...
            <div className="dashboard-body">
                ...
                <main className="dashboard-content">
                    ...
                    <div className="dark-panel animate-fade-up-delay-1">
                        ...
                        {activeTab === "create_patient" && <CreatePatientTab />}
